...
@Table(name = "googlemember") //테이블 관련 설정 어노테이션
public class GoogleMember {
    ...
    public GoogleMember(Long id, String name, String email, String provider, String nickname) {
        this.id = id;
        this.name = name;
        this.email = email;
    ...
    public GoogleMember update(String name, String email) {
        this.name = name;
        this.email = email;
        return this;
    }
