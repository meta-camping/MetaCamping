...
import com.example.meta.repository.GoogleMemberRepository;
...
public class OAuthService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        GoogleMember googlemember = saveOrUpdate(memberProfile);
    ...
    private GoogleMember saveOrUpdate(MemberProfile memberProfile) {

        GoogleMember googlemember = googlememberRepository.findByEmailAndProvider(memberProfile.getEmail(), memberProfile.getProvider())
